...
/* harmony default export */ __webpack_exports__["a"] = class {
    constructor({svg, organizationJson,　imageRadius = 30, expanseDirection = "vertical", animationDuration = 750}) {
        ...
        this.hierarchyRoot = __WEBPACK_IMPORTED_MODULE_0_d3__["hierarchy"](organizationJson, d => d.children);
        this._layOutTree()
    ...
    _layOutTree() {
        ...
        const treeLayout = __WEBPACK_IMPORTED_MODULE_0_d3__["tree"]().size([this.svg.attr('width')-this.nodeRadius*2, this.svg.attr('height')-this.nodeRadius*4]);
...
function translate(selection, coordinates) {
    const transform = __WEBPACK_IMPORTED_MODULE_0_d3__["zoomIdentity"].translate(coordinates.x, coordinates.y);
...
function appendLabel(selection, nodeRadius) {
    const labelGroup = selection.append('g')
        ...
        .attr("transform", d => {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_d3__["zoomIdentity"].translate(labelOffset.x, labelOffset.y);
        });
...
function openNodeDesign(selection, nodeRadius) {
    selection
        .attr("transform", d => __WEBPACK_IMPORTED_MODULE_0_d3__["zoomIdentity"].translate(d.x, d.y));
	...
	"children": [
		{
			...
			"lname": "Lidfors",
			"title": "Rektor, VD",
			"photo": "http://gripsholmsskolan.se/wp-content/uploads/2016/10/lärare49a-1.jpg",
			"children": [
				{
					"fname": "Mary",
					"lname": "Jane",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__OrganizationChart_js__ = __webpack_require__(1);
...
const jsonOrganisation = __webpack_require__(2);
